...
export { default as RelatiGameLite } from "./RelatiGameLite";
export type { RelatiGameLiteProps } from "./RelatiGameLite";
export { default as RelatiBoard } from "./RelatiBoard";
export type { RelatiBoardProps } from "./RelatiBoard";
export { default as RelatiBoardLite } from "./RelatiBoardLite";
export type { RelatiBoardLiteProps } from "./RelatiBoardLite";
