...
import { SCENEX_SCRIPTS } from "./utils";

const RelatiSceneX = ({ nextStep, board, ...props }: Props) => {
  ...
  useEffect(() => {
    const [description, ms, coordinate] = SCENEX_SCRIPTS[game.turn - 3] || [];
