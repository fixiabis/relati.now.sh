...
const RelatiPuzzleX7: RelatiPuzzleComponent = ({ game: externalGame, level: externalStep = "0", onLeave: handleLeave, onFinish: handleFinish, ...props }) => {
